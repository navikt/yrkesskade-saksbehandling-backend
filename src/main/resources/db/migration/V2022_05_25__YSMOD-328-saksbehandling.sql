...
(
    ...
    CONSTRAINT fk_dokument_id FOREIGN KEY (dokument_id) REFERENCES dokument_meta (dokument_id) ON DELETE CASCADE
);

-- 1-til-1 relasjon? - En behandling kan ha ett resultat?
CREATE TABLE behandling_resultat
(
    behandling_resultat_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    behandling_id          BIGINT       NOT NULL,
    resultat_tidspunkt     TIMESTAMP    NOT NULL,
    sted                   VARCHAR(255) NOT NULL,
    bakgrunn_aarsak        TEXT         NOT NULL,
